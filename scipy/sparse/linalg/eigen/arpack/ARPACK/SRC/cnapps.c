/* cnapps.f -- translated by f2c (version 20100827).
	...
	resid, complex *q, integer *ldq, complex *workl, complex *workd)
{
    ...
    extern /* Subroutine */ int cgemv_(char *, integer *, integer *, complex *
	    ...
	    ftnlen), slabad_(real *, real *), arscnd_(real *), clacpy_(char *,
    ...
    extern doublereal wslapy2_(real *, real *), wslamch_(char *, ftnlen), 
	    wclanhs_(char *, integer *, complex *, integer *, complex *, 
	    ftnlen);
...
/*           %----------------------------------------% */
	    ...
	    if (tst1 == 0.f) {
		i__3 = kplusp - jj + 1;
		tst1 = wclanhs_("1", &i__3, &h__[h_offset], ldh, &workl[1], (
			ftnlen)1);
	    }
...
/*        %--------------------------------------------% */
	...
	tst1 = (r__1 = h__[i__2].r, dabs(r__1)) + (r__2 = r_imag(&h__[i__ + 
		...
		r__4)));
	if (tst1 == 0.f) {
	    tst1 = wclanhs_("1", kev, &h__[h_offset], ldh, &workl[1], (ftnlen)
		    1);
	}
