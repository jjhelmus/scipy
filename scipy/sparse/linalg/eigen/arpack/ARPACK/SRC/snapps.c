/* snapps.f -- translated by f2c (version 20100827).
	...
	real *resid, real *q, integer *ldq, real *workl, real *workd)
{
    ...
    extern /* Subroutine */ int sscal_(integer *, real *, real *, integer *), 
	    ...
	    , real *, integer *, integer *, char *, ftnlen), svout_(integer *,
	     integer *, real *, integer *, char *, ftnlen), slabad_(real *, 
	    real *);
    static real sigmai;
    ...
    extern doublereal wslapy2_(real *, real *), wslamch_(char *, ftnlen), 
	    wslanhs_(char *, integer *, real *, integer *, real *, ftnlen);
...
/*           %----------------------------------------% */
	    ...
	    if (tst1 == 0.f) {
		i__3 = kplusp - jj + 1;
		tst1 = wslanhs_("1", &i__3, &h__[h_offset], ldh, &workl[1], (
			ftnlen)1);
	    }
/* Computing MAX */
	    r__2 = ulp * tst1;
...
/*        %--------------------------------------------% */
	...
	if (tst1 == 0.f) {
	    tst1 = wslanhs_("1", kev, &h__[h_offset], ldh, &workl[1], (ftnlen)
		    1);
	}
/* Computing MAX */
	r__1 = ulp * tst1;
