/* cnaupd.f -- translated by f2c (version 20100827).
...
/*          DEFAULT = wslamch('EPS')  (machine precision as computed */
/*                    by the LAPACK auxiliary subroutine wslamch). */
	...
	bmat_len, ftnlen which_len)
{
    ...
    extern /* Subroutine */ int cvout_(integer *, integer *, complex *, 
	    ...
	    integer *, complex *, real *, integer *, ftnlen, ftnlen), arscnd_(
	    real *);
