/* ssaitr.f -- translated by f2c (version 20100827).
	...
	integer *info, ftnlen bmat_len)
{
    ...
    static integer jj, ipj, irj, ivj, ierr, iter, itry;
    static real temp1;
    ...
    extern /* Subroutine */ int slascl_(char *, integer *, integer *, real *, 
	    ...
	    ftnlen);
    extern doublereal wslamch_(char *, ftnlen);
...
/*        %--------------------------------% */
	...
	safmin = wslamch_("safmin", (ftnlen)6);
    }
...
/*           %----------------------------------% */
	...
	wnorm = wsdot_(n, &resid[1], &c__1, &workd[ivj], &c__1);
