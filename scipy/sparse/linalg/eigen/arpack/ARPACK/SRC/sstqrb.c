/* sstqrb.f -- translated by f2c (version 20100827).
...
/*     wslanst  LAPACK routine that computes the norm of a matrix. */
	...
	work, integer *info)
{
    ...
    extern doublereal wslapy2_(real *, real *), wslamch_(char *, ftnlen), 
	    wslanst_(char *, integer *, real *, real *, ftnlen);
...
/*     determine the unit roundoff and over/underflow thresholds. */
    ...
    eps = wslamch_("e", (ftnlen)1);
/* Computing 2nd power */
    r__1 = eps;
    eps2 = r__1 * r__1;
    safmin = wslamch_("s", (ftnlen)1);
    safmax = 1.f / safmin;
...
/*     scale submatrix in rows and columns l to lend */
    ...
    i__1 = lend - l + 1;
    anorm = wslanst_("i", &i__1, &d__[l], &e[l], (ftnlen)1);
    iscale = 0;
    if (anorm == 0.f) {
	goto L10;
    }
