/* sneigh.f -- translated by f2c (version 20100827).
	...
	workl, integer *ierr)
{
    ...
    extern doublereal wslapy2_(real *, real *);
...
/*           %----------------------% */
	    ...
	    temp = wsnrm2_(n, &q[i__ * q_dim1 + 1], &c__1);
	    r__1 = 1.f / temp;
...
/*           %-------------------------------------------% */
	    ...
	    if (iconj == 0) {
		r__1 = wsnrm2_(n, &q[i__ * q_dim1 + 1], &c__1);
		r__2 = wsnrm2_(n, &q[(i__ + 1) * q_dim1 + 1], &c__1);
...
/*           %-------------------------------------------% */
	    ...
	    if (iconj == 0) {
		bounds[i__] = *rnorm * wslapy2_(&workl[i__], &workl[i__ + 1]);
