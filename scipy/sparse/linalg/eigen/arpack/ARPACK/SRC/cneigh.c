/* cneigh.f -- translated by f2c (version 20100827).
	...
	complex *workl, real *rwork, integer *ierr)
{
    ...
    extern /* Subroutine */ int ccopy_(integer *, complex *, integer *, 
	    ...
	    , integer *, complex *, integer *, char *, ftnlen), csscal_(
	    integer *, real *, complex *, integer *), clahqr_(logical *, 
...
/*     %------------------------------------------------% */
    ...
    i__1 = *n;
    for (j = 1; j <= i__1; ++j) {
	temp = wscnrm2_(n, &q[j * q_dim1 + 1], &c__1);
	r__1 = 1.f / temp;
