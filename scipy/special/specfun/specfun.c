/* specfun.f -- translated by f2c (version 20100827).
...
static real c_b381 = 2.f;
static doublereal c_b387 = 1.27;
static integer c__0 = 0;
static doublereal c_b593 = 1.;
static integer c__1 = 1;
static doublecomplex c_b1286 = {-2.,0.};
static doublereal c_b1293 = .33333;
static doublecomplex c_b1511 = {-1.,0.};
...
/*       ********************************** */
/* Subroutine */ int cjy01_(doublecomplex *z__, doublecomplex *cbj0, 
	doublecomplex *cdj0, doublecomplex *cbj1, doublecomplex *cdj1, 
	doublecomplex *cby0, doublecomplex *cdy0, doublecomplex *cby1, 
	doublecomplex *cdy1)
{
    /* Initialized data */
...
/*       ********************************** */
/* Subroutine */ int csphjy_(integer *n, doublecomplex *z__, integer *nm, 
	doublecomplex *csj, doublecomplex *cdj, doublecomplex *csy, 
	doublecomplex *cdy)
{
    /* System generated locals */
...
L55:
	...
	*id = 10;
    ...
    b0 = *kd * *m / pow_dd(x, &c_b199) / (1.f - *kd / (*x * *x)) * *r2f;
    sud = 0.;
    eps2 = 0.;
    i__1 = nm;
    for (k = 1; k <= i__1; ++k) {
...
/*       ********************************** */
/* Subroutine */ int stvl1_(doublereal *x, doublereal *sl1)
{
    /* System generated locals */
    integer i__1;
    doublereal d__1;
...
/*       ********************************** */
/* Subroutine */ int stvl0_(doublereal *x, doublereal *sl0)
{
    /* System generated locals */
    integer i__1;
    doublereal d__1;
...
/* L65: */
    ...
    sa0 = ((*m + ip) * 2.f + 1.f) * r1 / (pow_ri(&c_b381, n) * pow_di(c__, &
	    ip) * r2 * r3 * df[1]);
    *ck1 = sa0 * su0;
    if (*kd == -1) {
	return 0;
...
/*       ********************************** */
/* Subroutine */ int stvh1_(doublereal *x, doublereal *sh1)
{
    /* System generated locals */
    integer i__1;
...
/*       ********************************** */
/* Subroutine */ int stvh0_(doublereal *x, doublereal *sh0)
{
    /* System generated locals */
    integer i__1;
    doublereal d__1;
...
L25:
	    ...
	    gm = 0.;
	    d__1 = *c__ - *a - *b;
	    mcab = (integer) (*c__ - *a - *b + eps * d_sign(&c_b593, &d__1));
...
L105:
	...
	d__1 = *a - *b;
	mab = (integer) (*a - *b + eps * d_sign(&c_b593, &d__1));
...
L115:
		...
		*b = aa;
	    ...
	    ca = *c__ - *a;
	    cb = *c__ - *b;
	    nca = (integer) (ca + eps * d_sign(&c_b593, &ca));
	    ncb = (integer) (cb + eps * d_sign(&c_b593, &cb));
...
/*       ********************************** */
/* Subroutine */ int cjyna_(integer *n, doublecomplex *z__, integer *nm, 
	doublecomplex *cbj, doublecomplex *cdj, doublecomplex *cby, 
	doublecomplex *cdy)
{
    /* System generated locals */
    ...
    static doublecomplex cyk, cbj0, cbj1, cdj0, cdj1, cby0, cby1, cdy0, cdy1, 
	    cyl1, cyl2;
    extern /* Subroutine */ int cjy01_(doublecomplex *, doublecomplex *, 
...
L55:
    *r1f *= a0;
    b0 = *kd * *m / pow_dd(x, &c_b199) / (1.f - *kd / (*x * *x)) * *r1f;
    sud = 0.;
    sw = 0.;
    i__1 = nm;
    for (k = 1; k <= i__1; ++k) {
...
/*       ********************************** */
/* Subroutine */ int stvlv_(doublereal *v, doublereal *x, doublereal *slv)
{
    /* System generated locals */
    integer i__1;
    doublereal d__1, d__2;
    ...
    static doublereal r__, s, u, r1, r2, s0, v0, u0, ga, gb, bf, sa, va, vb, 
	    pi, vt, bf0, bf1, biv, biv0;
    extern /* Subroutine */ int gamma2_(doublereal *, doublereal *);
...
/* Computing 2nd power */
		d__1 = k * 2.f - 1.;
		r__ = r__ * -.125f * (vt * 4.f * vt - d__1 * d__1) / (k * *x);
		biv += r__;
...
/*       ********************************** */
/* Subroutine */ int csphik_(integer *n, doublecomplex *z__, integer *nm, 
	doublecomplex *csi, doublecomplex *cdi, doublecomplex *csk, 
	doublecomplex *cdk)
{
    /* System generated locals */
    integer i__1, i__2, i__3, i__4;
...
/*          Abr & Stg (9.5.14) */
	d__1 = (doublereal) (*n);
	d__2 = (doublereal) (*n);
	x = *n + pow_dd(&d__1, &c_b1293) * 1.85576f + 1.03315f / pow_dd(&d__2,
		 &c_b1293);
    }
    l = 0;
/*       2) iterate */
...
/*       -- Newton method for j_{N,L}' */
	...
	d__1 = (doublereal) (*n);
	d__2 = (doublereal) (*n);
	x = *n + pow_dd(&d__1, &c_b1293) * .80861f + .07249f / pow_dd(&d__2, &
		c_b1293);
    }
    if (*n == 0) {
	x = 3.8317f;
...
/*       -- Newton method for y_{N,L} */
	...
	d__1 = (doublereal) (*n);
	d__2 = (doublereal) (*n);
	x = *n + pow_dd(&d__1, &c_b1293) * .93158f + .26035f / pow_dd(&d__2, &
		c_b1293);
    }
    l = 0;
    xguess = x;
...
/*       -- Newton method for y_{N,L}' */
	...
	d__1 = (doublereal) (*n);
	d__2 = (doublereal) (*n);
	x = *n + pow_dd(&d__1, &c_b1293) * 1.8211f + .94001f / pow_dd(&d__2, &
		c_b1293);
    }
    l = 0;
    xguess = x;
...
/*       ********************************** */
/* Subroutine */ int stvhv_(doublereal *v, doublereal *x, doublereal *hv)
{
    /* System generated locals */
    integer i__1;
    doublereal d__1, d__2;
    ...
    /* Local variables */
    static integer k, l, n;
    static doublereal s, u, r1, r2, s0, v0, u0, t0, t1, bf, ga, gb, sa, va, 
	    vb, pi, sr, vt, bf0, bf1, bj0, bj1, by0, by1, pu0, qu0, pu1, qu1, 
	    bjv, byv;
    extern /* Subroutine */ int gamma2_(doublereal *, doublereal *);
