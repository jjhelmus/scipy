/* cdffnc.f -- translated by f2c (version 20100827).
	...
	integer *status, doublereal *bound)
{
    ...
    extern /* Subroutine */ int dinvr_(integer *, doublereal *, doublereal *, 
	    ...
	    doublereal *, doublereal *, doublereal *, doublereal *), dstinv_(
...
L160:
	...
	cumfnc_(f, dfn, dfd, phonc, &cum, &ccum);
	fx = cum - *p;
	dinvr_(status, f, &fx, &qleft, &qhi);
	goto L160;
L170:
